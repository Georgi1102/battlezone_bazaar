...
const Carousel = (props) => {
    ...
    return (
        <div className='carousel-container  bg-black flex flex-col justify-between h-[60vh]'>
            <div>
                <span className='text-white text-3xl font-bold flex justify-center'>Popular Products</span>
            ...
            <div className='flex flex-row justify-evenly'>
                ...
                <div className='border-2 w-24 h-12 text-white flex items-center justify-center' onClick={() => navigate("/catalog")} style={{ cursor: "pointer" }}>VIEW</div>
            </div>
        </div>
    )
}
